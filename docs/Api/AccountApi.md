...
```php
accountCartList($store_url, $store_key, $request_from_date, $request_to_date, $custom_label, $params, $exclude): \OpenAPI\Client\Model\AccountCartList200Response
```
...
$americommerce_app_id = 1; // string | Americommerce App ID
$americommerce_app_secret = 9fd3d282d65a007a2b9d541b5e0e410b2cecd6199632db53503b93637b8a6000; // string | Americommerce App Secret
$americommerce_access_token = 1e721f59b610e2666caea03094600765; // string | Americommerce Access Token
$americommerce_refresh_token = 520c011444af41d916543cdda859a5114; // string | Americommerce Refresh Token
...
$shopify_client_id = b5defe55db3f6836fb4e0e6624ff9577; // string | Shopify Client ID
...
$mirakl_api_key = a1b2c3d4-e5f6-7890-abcd-ef1234567890; // string | Mirakl API Key
...
$nopcommerce_token = igse8e4rdmzkxdi937qe69d59en1imw; // string | Access token authorizing the app to access resources on behalf of a user
$nopcommerce_secret = a1f3c9e72b6d480fa5c81e9b7d2f04a63e8c5b1a9d7f3026e4b8c1a2f5d6e093; // string | nopCommerce webhook signing secret generated by the Api2Cart.Connector plugin. Optional when connecting a store, but required to receive webhooks from it.
...
$walmart_refresh_token = eyJraWQiOiIxYmIxMTYyNS1lM2Y2LTQyNWMtOTkwMS0zZTdiNmJhNzZmNjIiLCJhbGciOiJSUzI1NiJ9; // string | Walmart refresh token received by a Solution Provider application through the Walmart App Store authorization. When it is set, walmart_client_id and walmart_client_secret are the credentials of that application, not of the seller. Must be used together with walmart_seller_id and is supported only for walmart_region = 'us'
$walmart_seller_id = 10000004372; // string | Walmart seller id the refresh token was issued for, sent as the WM_PARTNER.ID header. Must be used together with walmart_refresh_token and is supported only for walmart_region = 'us'
...
$jumpseller_client_id = your_client_id; // string | Jumpseller OAuth2 Client ID
$jumpseller_client_secret = your_client_secret; // string | Jumpseller OAuth2 Client Secret
$jumpseller_refresh_token = your_oauth_refresh_token; // string | Jumpseller OAuth2 refresh token
$jumpseller_login = your_login; // string | Jumpseller API login
$jumpseller_authtoken = your_auth_token; // string | Jumpseller API auth token
...
$scapi_client_id = b941ec85-v6b2-1dw8-9fe2-98e1d6eec7b1; // string | Salesforce Commerce API Client ID
$scapi_client_secret = testpassword; // string | Salesforce Commerce API Client Secret
$scapi_organization_id = f_ecom_xxxx_001; // string | Salesforce Commerce Organization ID
$scapi_short_code = zs5ksm25; // string | Salesforce Commerce Short Code
$scapi_scopes = sfcc.catalogs,sfcc.orders,sfcc.products; // string | Salesforce Commerce API Scopes
...
| **americommerce_app_id** | **string**| Americommerce App ID | [optional] |
| **americommerce_app_secret** | **string**| Americommerce App Secret | [optional] |
| **americommerce_access_token** | **string**| Americommerce Access Token | [optional] |
| **americommerce_refresh_token** | **string**| Americommerce Refresh Token | [optional] |
...
| **shopify_client_id** | **string**| Shopify Client ID | [optional] |
...
| **mirakl_api_key** | **string**| Mirakl API Key | [optional] |
...
| **nopcommerce_token** | **string**| Access token authorizing the app to access resources on behalf of a user | [optional] |
| **nopcommerce_secret** | **string**| nopCommerce webhook signing secret generated by the Api2Cart.Connector plugin. Optional when connecting a store, but required to receive webhooks from it. | [optional] |
...
| **jumpseller_client_id** | **string**| Jumpseller OAuth2 Client ID | [optional] |
| **jumpseller_client_secret** | **string**| Jumpseller OAuth2 Client Secret | [optional] |
| **jumpseller_refresh_token** | **string**| Jumpseller OAuth2 refresh token | [optional] |
| **jumpseller_login** | **string**| Jumpseller API login | [optional] |
| **jumpseller_authtoken** | **string**| Jumpseller API auth token | [optional] |
...
| **scapi_client_id** | **string**| Salesforce Commerce API Client ID | [optional] |
| **scapi_client_secret** | **string**| Salesforce Commerce API Client Secret | [optional] |
| **scapi_organization_id** | **string**| Salesforce Commerce Organization ID | [optional] |
| **scapi_short_code** | **string**| Salesforce Commerce Short Code | [optional] |
| **scapi_scopes** | **string**| Salesforce Commerce API Scopes | [optional] |
