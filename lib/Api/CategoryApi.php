...
class CategoryApi
{
     ...
     * @param  string|null $params Important! Parameter deprecated, use response_fields instead. Set this parameter in order to choose which entity fields you want to retrieve (optional, default to 'id,parent_id,name,description')
