...
/**
 * SubscriberApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class SubscriberApi
{
    ...
    /**
     * Operation subscriberListWithHttpInfo
     *
     * subscriber.list
     *
     * @param  int|null $start This parameter sets the number from which you want to get entities (optional, default to 0)
    ...
    public function subscriberListWithHttpInfo($start = 0, $count = 10, $subscribed = null, $store_id = null, $email = null, $params = 'force_all', $exclude = null, $created_from = null, $created_to = null, $modified_from = null, $modified_to = null, $page_cursor = null, $response_fields = null, string $contentType = self::contentTypes['subscriberList'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ModelResponseSubscriberList' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ModelResponseSubscriberList' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ModelResponseSubscriberList', []),
    ...
    /**
     * Operation subscriberListAsyncWithHttpInfo
     *
     * subscriber.list
     *
     * @param  int|null $start This parameter sets the number from which you want to get entities (optional, default to 0)
