...
class AccountApi
{
     ...
     */
    public function accountCartList($params = 'force_all', $exclude = null, $request_from_date = null, $request_to_date = null, $store_url = null, $store_key = null, string $contentType = self::contentTypes['accountCartList'][0])
    {
        list($response) = $this->accountCartListWithHttpInfo($params, $exclude, $request_from_date, $request_to_date, $store_url, $store_key, $contentType);
        return $response;
    }
     ...
     */
    public function accountCartListWithHttpInfo($params = 'force_all', $exclude = null, $request_from_date = null, $request_to_date = null, $store_url = null, $store_key = null, string $contentType = self::contentTypes['accountCartList'][0])
    {
        $request = $this->accountCartListRequest($params, $exclude, $request_from_date, $request_to_date, $store_url, $store_key, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function accountCartListAsync($params = 'force_all', $exclude = null, $request_from_date = null, $request_to_date = null, $store_url = null, $store_key = null, string $contentType = self::contentTypes['accountCartList'][0])
    {
        return $this->accountCartListAsyncWithHttpInfo($params, $exclude, $request_from_date, $request_to_date, $store_url, $store_key, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function accountCartListAsyncWithHttpInfo($params = 'force_all', $exclude = null, $request_from_date = null, $request_to_date = null, $store_url = null, $store_key = null, string $contentType = self::contentTypes['accountCartList'][0])
    {
        $returnType = '\OpenAPI\Client\Model\AccountCartList200Response';
        $request = $this->accountCartListRequest($params, $exclude, $request_from_date, $request_to_date, $store_url, $store_key, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function accountCartListRequest($params = 'force_all', $exclude = null, $request_from_date = null, $request_to_date = null, $store_url = null, $store_key = null, string $contentType = self::contentTypes['accountCartList'][0])
    {
     ...
     */
    public function accountFailedWebhooks($count = 10, $start = 0, $ids = null, string $contentType = self::contentTypes['accountFailedWebhooks'][0])
    {
        list($response) = $this->accountFailedWebhooksWithHttpInfo($count, $start, $ids, $contentType);
        return $response;
    }
     ...
     */
    public function accountFailedWebhooksWithHttpInfo($count = 10, $start = 0, $ids = null, string $contentType = self::contentTypes['accountFailedWebhooks'][0])
    {
        $request = $this->accountFailedWebhooksRequest($count, $start, $ids, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function accountFailedWebhooksAsync($count = 10, $start = 0, $ids = null, string $contentType = self::contentTypes['accountFailedWebhooks'][0])
    {
        return $this->accountFailedWebhooksAsyncWithHttpInfo($count, $start, $ids, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function accountFailedWebhooksAsyncWithHttpInfo($count = 10, $start = 0, $ids = null, string $contentType = self::contentTypes['accountFailedWebhooks'][0])
    {
        $returnType = '\OpenAPI\Client\Model\AccountFailedWebhooks200Response';
        $request = $this->accountFailedWebhooksRequest($count, $start, $ids, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function accountFailedWebhooksRequest($count = 10, $start = 0, $ids = null, string $contentType = self::contentTypes['accountFailedWebhooks'][0])
    {
