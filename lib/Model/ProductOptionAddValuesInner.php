...
/**
 * ProductOptionAddValuesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProductOptionAddValuesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductOptionAdd_values_inner';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['display_value']) && (mb_strlen($this->container['display_value']) < 1)) {
    ...
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $value when calling ProductOptionAddValuesInner., must be bigger than or equal to 1.');
        }
    ...
    public function setDisplayValue($display_value)
    {
        ...
        if ((mb_strlen($display_value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $display_value when calling ProductOptionAddValuesInner., must be bigger than or equal to 1.');
        }
