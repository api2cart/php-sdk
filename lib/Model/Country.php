...
class Country implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('code2', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($code2)) {
            throw new \InvalidArgumentException('non-nullable code2 cannot be null');
        }
