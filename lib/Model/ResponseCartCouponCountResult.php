...
/**
 * ResponseCartCouponCountResult Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseCartCouponCountResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Response_Cart_Coupon_Count_Result';
    ...
    {
        $this->setIfExists('coupons_count', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($coupons_count)) {
            array_push($this->openAPINullablesSetToNull, 'coupons_count');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('coupons_count', $nullablesSetToNull);
            if ($index !== FALSE) {
