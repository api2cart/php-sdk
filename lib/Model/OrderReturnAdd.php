...
/**
 * OrderReturnAdd Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OrderReturnAdd implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderReturnAdd';
    ...
    protected static $openAPITypes = [
        ...
        'order_products' => '\OpenAPI\Client\Model\OrderReturnAddOrderProductsInner[]'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['return_status_id'] === null) {
            $invalidProperties[] = "'return_status_id' can't be null";
        }
        if ($this->container['return_action_id'] === null) {
            $invalidProperties[] = "'return_action_id' can't be null";
        }
        if ($this->container['return_reason_id'] === null) {
            $invalidProperties[] = "'return_reason_id' can't be null";
        }
     ...
     *
     * @param string $return_status_id Defines return request status
     *
     * @return self
     */
     ...
     *
     * @param string $return_action_id Defines return request action
     *
     * @return self
     */
     ...
     *
     * @param string $return_reason_id Defines return request reason
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message Customer-visible message attached to the return request.
     *
     * @return self
     */
     ...
     * Gets order_products
     *
     * @return \OpenAPI\Client\Model\OrderReturnAddOrderProductsInner[]
     */
     ...
     * Sets order_products
     *
     * @param \OpenAPI\Client\Model\OrderReturnAddOrderProductsInner[] $order_products order_products
     *
     * @return self
     */
