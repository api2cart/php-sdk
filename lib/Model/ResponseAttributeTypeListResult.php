...
/**
 * ResponseAttributeTypeListResult Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseAttributeTypeListResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Response_Attribute_Type_List_Result';
    ...
    */
    ...
    public function setItemsCount($items_count)
    {
        if (is_null($items_count)) {
            array_push($this->openAPINullablesSetToNull, 'items_count');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('items_count', $nullablesSetToNull);
            if ($index !== FALSE) {
