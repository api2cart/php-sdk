...
/**
 * ProductVariantImageAdd Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProductVariantImageAdd implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductVariantImageAdd';
    ...
    */
     ...
     * Sets product_id
     *
     * @param string|null $product_id Defines product id where the variant image has to be added
     *
     * @return self
     */
     ...
     *
     * @param string $product_variant_id Defines product's variants specified by variant id
     *
     * @return self
     */
     ...
     * Sets option_id
     *
     * @param string|null $option_id Defines option id of the product variant for which the image will be added
     *
     * @return self
     */
