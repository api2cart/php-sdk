...
/**
 * ProductVariantPriceAdd Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProductVariantPriceAdd implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductVariantPriceAdd';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Defines the variant to which the price has to be added
     *
     * @return self
     */
     ...
     * Gets group_prices
     *
     * @return \OpenAPI\Client\Model\ProductAddGroupPricesInner[]
     */
     ...
     * Sets group_prices
     *
     * @param \OpenAPI\Client\Model\ProductAddGroupPricesInner[] $group_prices Defines variants's group prices
     *
     * @return self
     */
