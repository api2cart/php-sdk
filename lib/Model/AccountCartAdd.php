...
class AccountCartAdd implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'nopcommerce_secret' => 'setNopcommerceSecret',
    ...
    protected static $getters = [
        ...
        'nopcommerce_secret' => 'getNopcommerceSecret',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('nopcommerce_secret', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets nopcommerce_secret
     *
     * @return string|null
     */
    public function getNopcommerceSecret()
    {
        return $this->container['nopcommerce_secret'];
    }

    /**
     * Sets nopcommerce_secret
     *
     * @param string|null $nopcommerce_secret nopCommerce webhook signing secret generated by the Api2Cart.Connector plugin. Optional when connecting a store, but required to receive webhooks from it.
     *
     * @return self
     */
    public function setNopcommerceSecret($nopcommerce_secret)
    {
        if (is_null($nopcommerce_secret)) {
            throw new \InvalidArgumentException('non-nullable nopcommerce_secret cannot be null');
        }
        $this->container['nopcommerce_secret'] = $nopcommerce_secret;
