...
/**
 * CustomerUpdateAddressInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CustomerUpdateAddressInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerUpdate_address_inner';
    ...
    {
        $this->setIfExists('address_book_id', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $address_book_id The ID of the address.
     *
     * @return self
     */
    public function setAddressBookId($address_book_id)
    {
        if (is_null($address_book_id)) {
            throw new \InvalidArgumentException('non-nullable address_book_id cannot be null');
        }
