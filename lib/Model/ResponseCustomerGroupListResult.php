...
/**
 * ResponseCustomerGroupListResult Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseCustomerGroupListResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Response_Customer_Group_List_Result';
    ...
    */
    ...
    public function setGroupCount($group_count)
    {
        if (is_null($group_count)) {
            array_push($this->openAPINullablesSetToNull, 'group_count');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('group_count', $nullablesSetToNull);
            if ($index !== FALSE) {
