...
/**
 * ProductAddSpecificsInnerBookingDetailsAvailabilitiesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProductAddSpecificsInnerBookingDetailsAvailabilitiesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductAdd_specifics_inner_booking_details_availabilities_inner';
    ...
    protected static $openAPITypes = [
        'day' => 'string',
        'is_available' => 'bool',
        'times' => '\OpenAPI\Client\Model\ProductAddSpecificsInnerBookingDetailsAvailabilitiesInnerTimesInner[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('is_available', $data ?? [], true);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['times']) && (count($this->container['times']) < 1)) {
            $invalidProperties[] = "invalid value for 'times', number of items must be greater than or equal to 1.";
        }
     ...
     * Gets times
     *
     * @return \OpenAPI\Client\Model\ProductAddSpecificsInnerBookingDetailsAvailabilitiesInnerTimesInner[]|null
     */
     ...
     * Sets times
     *
     * @param \OpenAPI\Client\Model\ProductAddSpecificsInnerBookingDetailsAvailabilitiesInnerTimesInner[]|null $times times
     *
     * @return self
     */
    public function setTimes($times)
    {
        ...
        if ((count($times) < 1)) {
            throw new \InvalidArgumentException('invalid length for $times when calling ProductAddSpecificsInnerBookingDetailsAvailabilitiesInner., number of items must be greater than or equal to 1.');
        }
