...
/**
 * ResponseCartCouponListResult Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseCartCouponListResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Response_Cart_Coupon_List_Result';
    ...
    {
        $this->setIfExists('coupon_count', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['coupon_count'];
    }

    /**
     * Sets coupon_count
     *
     * @param int|null $coupon_count coupon_count
     *
     * @return self
     */
