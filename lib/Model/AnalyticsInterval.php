...
/**
 * AnalyticsInterval Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AnalyticsInterval implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Analytics_Interval';
    ...
    protected static $openAPITypes = [
        'date_from' => 'string',
        'date_to' => 'string',
        'metrics' => '\OpenAPI\Client\Model\AnalyticsMetric',
    ...
    */
     ...
     * Sets metrics
     *
     * @param \OpenAPI\Client\Model\AnalyticsMetric|null $metrics metrics
     *
     * @return self
     */
