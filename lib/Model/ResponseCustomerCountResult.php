...
/**
 * ResponseCustomerCountResult Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseCustomerCountResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Response_Customer_Count_Result';
    ...
    */
     ...
     *
     * @param int|null $customers_count customers_count
     *
     * @return self
     */
    public function setCustomersCount($customers_count)
    {
        if (is_null($customers_count)) {
            array_push($this->openAPINullablesSetToNull, 'customers_count');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('customers_count', $nullablesSetToNull);
            if ($index !== FALSE) {
