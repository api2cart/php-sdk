 ...
 */
class ProductAddPersonalizationDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductAdd_personalization_details';
    ...
    */
     ...
     *
     * @param bool $is_personalizable is_personalizable
     *
     * @return self
     */
     ...
     *
     * @param bool|null $personalization_is_required personalization_is_required
     *
     * @return self
     */
     ...
     *
     * @param int|null $personalization_char_count_max personalization_char_count_max
     *
     * @return self
     */
    public function setPersonalizationCharCountMax($personalization_char_count_max)
    {
        if (is_null($personalization_char_count_max)) {
            throw new \InvalidArgumentException('non-nullable personalization_char_count_max cannot be null');
        }
     ...
     *
     * @param string|null $personalization_instructions personalization_instructions
     *
     * @return self
     */
