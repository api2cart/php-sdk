...
/**
 * ResponseProductCountResult Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseProductCountResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Response_Product_Count_Result';
    ...
    */
    ...
    public function setProductsCount($products_count)
    {
        if (is_null($products_count)) {
            array_push($this->openAPINullablesSetToNull, 'products_count');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('products_count', $nullablesSetToNull);
            if ($index !== FALSE) {
