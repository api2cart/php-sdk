...
/**
 * ResponseOrderTransactionListResult Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseOrderTransactionListResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Response_Order_Transaction_List_Result';
    ...
    */
    ...
    public function setTransactionsCount($transactions_count)
    {
        if (is_null($transactions_count)) {
            array_push($this->openAPINullablesSetToNull, 'transactions_count');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('transactions_count', $nullablesSetToNull);
            if ($index !== FALSE) {
