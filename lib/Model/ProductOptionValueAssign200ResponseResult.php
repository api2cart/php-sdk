...
/**
 * ProductOptionValueAssign200ResponseResult Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProductOptionValueAssign200ResponseResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductOptionValueAssign_200_response_result';
    ...
    */
    ...
    public function setProductOptionValueId($product_option_value_id)
    {
        if (is_null($product_option_value_id)) {
            throw new \InvalidArgumentException('non-nullable product_option_value_id cannot be null');
        }
