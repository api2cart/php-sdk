...
/**
 * ProductVariantAddAttributesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProductVariantAddAttributesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductVariantAdd_attributes_inner';
    ...
    */
    ...
    /**
     * Gets attribute_price
     *
     * @return float|null
     */
    public function getAttributePrice()
    {
        return $this->container['attribute_price'];
    }

    /**
     * Sets attribute_price
     *
     * @param float|null $attribute_price attribute_price
     *
     * @return self
     */
    public function setAttributePrice($attribute_price)
    {
        if (is_null($attribute_price)) {
