...
/**
 * AnalyticsCustomerMetric Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AnalyticsCustomerMetric implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Analytics_CustomerMetric';
    ...
    */
     ...
     * Sets total_spend
     *
     * @param float|null $total_spend total_spend
     *
     * @return self
     */
    public function setTotalSpend($total_spend)
    {
        if (is_null($total_spend)) {
            array_push($this->openAPINullablesSetToNull, 'total_spend');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('total_spend', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
